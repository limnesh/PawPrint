...
var MypetsPage = /** @class */ (function () {
    function MypetsPage(formBuilder, Camera, Toast, core, http, storage, storageMul, alertCtrl, navCtrl, platform) {
        var _this = this;
        this.formBuilder = formBuilder;
        this.Camera = Camera;
        this.Toast = Toast;
